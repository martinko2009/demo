    ...
    function setup($) {
        ...
        $.u.alert = {
            ...
            "info": function (msg, timeout) {
                alertMsg('alert alert-info', 'fa-info-circle', msg, timeout);
            },
            "success": function (msg, timeout) {
                alertMsg('alert alert-success', ' fa-check-circle', msg, timeout || (1000 * 2));
            },
            "warn": function (msg, timeout) {
                alertMsg('alert alert-warning', 'fa-warning', msg, timeout);
            },
        ...
        var alertMsg = function (className, icon, message, timeout) {
            ...
            if ($.u.alert.options.dialog) {
                ...
                $alert.css({"margin-left":($(document).width() - $alert.width()) / 2});
                $alert.show();
            }
