...
(function () {
    ...
    */
	$.u = $.u || {};
    $.extend(true, $.u);
    $.u.ajax = function (ajaxoptions, selector, message, spinneroptions) {
        if (!ajaxoptions) {
            ajaxoptions = {};
        }
        if (!spinneroptions) {
        ...
        if (ajaxoptions.async == null || ajaxoptions.async) {
            ajaxoptions.beforeSend = (function (thisSelector, opts, sopts) {
                return function () {
					...
					if(message){
						blockuiopts = {
							message: message, overlayCSS: { backgroundColor: sopts.backgroundColor || '#fff' }
						}
					}
                    var cssopt = {
        ...
        return $.ajax(ajaxoptions).always((function (thisSelector, opts) {
            return function () {
				...
				if(thisSelector == null  && (opts.async == null || opts.async)){
					$.unblockUI();
				}
            }
        })(selector, ajaxoptions, spinneroptions));
    ...
    $.u.ajaxp = function (ajaxoptions, selector, progressoptions) {
        ...
        if (ajaxoptions.async == null || ajaxoptions.async) {
            ajaxoptions.beforeSend = (function (thisSelector, opts, popts) {
                ...
                return function () {
                    var htm = "<div class='progress' style='height:" + height + ";width:" + width + "'><div class='progress-bar progress-bar-striped active'  role='progressbar' aria-valuenow='45' aria-valuemin='0' aria-valuemax='100' style='width: 100%'><span class='sr-only'>45% Complete</span></div></div>";
                    var blockuiopts = {
